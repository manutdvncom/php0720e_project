...
class ProductController extends Controller{
        ...
        if (isset($_POST['submit'])) {
            ...
            if (empty($title)) {
                ...
                if (!in_array($extension, $arr_extension)) {
                    ...
                    $this->error = 'File upload không được quá 5MB';
                }
            }
            ...
            if (empty($this->error)) {
                ...
                $is_insert = $product_model->getCreate();
                if ($is_insert) {
    ...
    public function update(){
        ...
        if (isset($_POST['submit'])) {
            ...
            if (empty($this->error)) {
                ...
                $is_update = $product_model->getUpdate($id);
                if ($is_update) {
        ...
        //lấy danh sách categories đang có trên hệ thống để phục vụ cho search
        $category_model = new Category();
        $categories = $category_model->getAll();
    ...
    public function delete(){
        ...
        $is_delete = $product_model->getDelete($id);
        if ($is_delete) {
